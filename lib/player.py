...
class Player(Moveable):
    ...
    def __init__(self, location, screen, environment, health, speed, master):
        ...
        super(Player, self).__init__(location, screen, environment, self.__sprite, health, speed, master)
